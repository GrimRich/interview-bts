    ...
    <v-dialog fullscreen v-model="$attrs.value" scrollable persistent>
      <v-card>
                ...
                <v-card-text>
                  <v-toolbar dense flat>
                    ...
                    <v-col cols="2">
                      ...
                      >
                        <div slot="no-options">
                          Maaf Folder anda tidak ditemukan.
                        </div>
                      </v-select>
                    </v-col>
                    <v-col cols="3">
                        ...
                        <div class="container-img">
                          ...
                          <template v-else>
                            <img
                              :src="
                                item.type == 0
                                  ? medium(process.env.API_URL + item.image)
                                  : item.type == 2
                      ...
                      >
                        <div class="container-img">
                          ...
                          <template v-else>
                            <img
                              v-if="item.type == '0'"
                              :src="medium(process.env.API_URL + item.image)"
                              class="hover--image"
                              alt
                              @click="images = item.image"
                              style="width:223px; height:160px; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover; padding:5px;"
              ...
              <v-card outlined>
                <v-card-text>
                  <v-row v-if="!isLoadingNews">
                    <template
                      v-for="(item, index) in listNews ? listNews.data : ''"
                    >
                      <v-col v-if="!multiple" :key="index" cols="3">
                        <v-card style="cursor:pointer">
                          ...
                          <v-img
                            v-else
                            :src="
                              medium(process.env.API_URL + item.cover_image)
                            "
                            height="200px"
                          ></v-img>
                        ...
                        <v-card stlye="cursor:pointer">
                          ...
                          <v-card-actions>
                            ...
                            <v-btn
                              ...
                              outlined
                              @click="
                                $refs.broadcastNews[index].$refs.input.click()
                              "
                            >
                              <v-icon>mdi-newspaper</v-icon>Pilih Berita
                            </v-btn>
        ...
        <v-card-actions v-if="tab == 'tab-4'">
          <v-spacer></v-spacer>
          <v-pagination
            v-model="paramsNews.page"
            :length="listNews.last_page"
          ></v-pagination>
          <v-btn
...
export default {
  ...
  data() {
    return {
      ...
      url: '',
      dropzoneOptions: {
        url: process.env.API_URL + 'api/image/plural',
        thumbnailWidth: 150,
